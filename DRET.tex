...
We have proposed two methods to identity fake APs in two different scenarios where the geneiue AP locates on a single, fixed or multiple positions. Our exprimental results show that our approach can detect 90\% of the fake APs with little extract overhead to the communication delay time. 
